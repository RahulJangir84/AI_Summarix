...
export default function HeroSection() {
  return (
    <MotionSection variants={containerVariants} initial="hidden" animate="visible" className="relative w-full overflow-hidden bg-white/50 dark:bg-slate-950">
      <div className="relative flex min-h-screen w-full flex-col items-start justify-start overflow-hidden">
        ...
        <div className="mt-24 w-full">
          <div className="relative z-10 container mx-auto px-4 my-10 flex flex-col items-center text-center">
            ...
            <MotionH1 variants={itemVariants} className="max-w-4xl text-2xl my-3 font-extrabold tracking-tight text-slate-900 sm:text-4xl md:text-5xl lg:text-6xl mb-6 flex flex-col md:flex-row gap-3 items-center justify-center">
            ...
            <MotionP variants={itemVariants} className="mx-auto lg:text-xl md:text-lg sm:text-base max-w-2xl my-5 text-slate-600 dark:text-slate-400 mb-10 leading-relaxed">
              Upload your documents and get instant, intelligent breakdowns of
              the content in seconds.
            </MotionP>
            <MotionDiv variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-4">
              <Button
                size="lg"
